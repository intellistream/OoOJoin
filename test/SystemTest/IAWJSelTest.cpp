...
TEST_CASE("Test IAWJSel running on random, watermarkTime = 10", "[short]")
{
    int a = 0;
    string configName, outPrefix = "";
    configName = "config_Normal.csv";
...
TEST_CASE("Test IAWJSel running on random, watermarkTime = 12", "[short]")
{
    int a = 0;
    string configName, outPrefix = "";
    configName = "config_Normal.csv";
...
TEST_CASE("Test IAWJSel running on random, watermarkTime = 14", "[short]")
{
    int a = 0;
    string configName, outPrefix = "";
    configName = "config_Normal.csv";
...
TEST_CASE("Test IAWJSel running on random, watermarkTime = 16", "[short]")
{
    int a = 0;
    string configName, outPrefix = "";
    configName = "config_Normal.csv";
