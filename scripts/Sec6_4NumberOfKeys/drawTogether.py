...
def main():
    ...
    groupLine.DrawFigureYnormal(periodAll, np.array(errAll) * 100.0, methodTags, "#Key", "Error (%)", 0, 1,
                                figPath + "sec6_4_NumberKey_err",
                                True)
    groupLine.DrawFigureYnormal(periodAll, np.array(lat95All), methodTags, "#Key", "95% latency (ms)", 0, 1,
                                figPath + "sec6_4_NumberKey_lat", True)
