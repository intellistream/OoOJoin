...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/Sec6_5InSystemStockq1/"
    ...
    # print(lat95All)
    # lat95All[3]=ts
    methodTags = ["alliancedb-SHJ", "alliancedb-NPJ", "alliancedb-PECJ"]
    resultPaths = ["SHJ", "NPJ", "PECJ"]
    csvTemplates = ["config_shj.csv", "config_npj.csv", "config_pecjSel.csv"]
    lat95All, errAll, periodAll, thrAll = compareMethod(exeSpace, commonBasePath, resultPaths, csvTemplates, periodVec,
                                                        reRun)
