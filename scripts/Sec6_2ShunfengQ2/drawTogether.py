...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/Sec6_2Shunfengq2/"
    ...
    groupLine.DrawFigure2(npLat, errAll, methodTags, "95% latency (ms)", "Error", 0, 1, figPath + "sec6_2_shunfeng_q2", True)
    ...
    groupBar2.DrawFigure(periodVec,npLat,methodTags,"Tuning knob "+r"$t_c$ (ms)","95% latency (ms)",5,15,figPath + "sec6_2_shunfeng_q2_lat", True)
    groupBar2.DrawFigure(periodVec,np.array(errAll)*100.0,methodTags,"Tuning knob "+r"$t_c$ (ms)","Error (%)",5,15,figPath + "sec6_2_shunfeng_q2_err", True)
