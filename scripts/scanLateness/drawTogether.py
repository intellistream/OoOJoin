...
def main():
    ...
    draw2yLine("lateness (ms)", periodVecDisp, lat95Vec, errVec, "95% Latency (ms)", "Error", "ms", "",
               figPath + "latWm_lat")
    draw2yLine("lateness  (ms)", periodVecDisp, thrVec, errVec, "Throughput (KTp/s)", "Error", "KTp/s", "",
               figPath + "latWm_thr")
    draw2yLine("lateness (ms)", periodVecDisp, lat95Vec, compVec, "95% Latency (ms)", "Completeness", "ms", "",
               figPath + "wm_omp")
    print(errVec)
