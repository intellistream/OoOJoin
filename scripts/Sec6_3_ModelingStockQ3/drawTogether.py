...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/Sec6_3MOdelingStockq3/"
    ...
    groupLine.DrawFigureYnormal(periodAll, np.array(errAll) * 100.0, methodTags, "Tuning knob " + r"$\omega$ (ms)",
